 ...
 * before</li>
 * <li>{@link #setOnDropDownListener(com.jason.usedcar.view.DropDownListView.OnDropDownListener)} set listener which will be excuted when drop down, but you
...
public class DropDownListView extends ListView implements OnScrollListener {
    ...
    private void getAttrs(Context context, AttributeSet attrs) {
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.DropDownListView);
        isDropDownStyle = ta.getBoolean(R.styleable.DropDownListView_isDropDownStyle, false);
        isOnBottomStyle = ta.getBoolean(R.styleable.DropDownListView_isOnBottomStyle, false);
        isAutoLoadOnBottom = ta.getBoolean(R.styleable.DropDownListView_isAutoLoadOnBottom, false);
        ta.recycle();
    }
}
