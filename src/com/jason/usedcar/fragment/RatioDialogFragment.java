...
public class RatioDialogFragment extends DialogFragment {
    ...
    public interface Callback {
        public void itemClicked(int type, int percentage);
    }
    ...
    public void onViewCreated(final View view, final Bundle savedInstanceState) {
        ...
        ratioList.setAdapter(new BaseAdapter() {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                textView.setText(String.valueOf(DATA[position]).concat("%"));
                return convertView;
            }
        });
        ratioList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(final AdapterView<?> parent, final View view, final int position, final long id) {
                ((Callback) getActivity()).itemClicked(RATIO, (Integer) ratioList.getAdapter().getItem(position));
                dismiss();
            }
        });
    }
