...
import com.jason.usedcar.pm.OrderListPM2;
 ...
 */
public class SaleCarFragment extends AbsFragment implements OrderListView {

    private OrderListModel model;

    private OrderListPM2 viewModel;
    ...
    protected Object presentationModel() {
        return viewModel = new OrderListPM2(model, this);
    }
